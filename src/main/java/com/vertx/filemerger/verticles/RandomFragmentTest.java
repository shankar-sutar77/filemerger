...
public class RandomFragmentTest extends AbstractVerticle {
    int start = 0;
    int fileSize = 0;
    int count = 0;
    ...
    public void start() throws Exception {
        ...
        vertx.setPeriodic(1, id -> {
            ...
            if (status_map.get(fileName) == null) {
                ...
                createFragmentsOfFile(file, fileName);
            } else {
                if (status_map.get(fileName + "fragmented") != null) {
                    ...
                    if (status_map.get(fileName + "_" + randomFragment) == null) {
                        ...
                        this.sendFragment(fileName, randomFragment);
                    }
                }
            }
        });
    ...
    private void createFragmentsOfFile(File file, String fileName) {
    ...
    void sendFragment(String fileName, int randomFragment) {
